...
def generate_launch_description():
    ...
    # cam_resource_path = SetEnvironmentVariable(name='GAZEBO_MODEL_PATH', value=[
    #                                             EnvironmentVariable('GAZEBO_MODEL_PATH',
    #                                                                 default_value=''),
    #                                             '/usr/share/gazebo-11/models/:',
    #                                             str(Path(get_package_share_directory('jackal_description')).
    #                                                 joinpath('urdf', 'hokuyo_ust10.urdf.xacro').resolve())])
    ...
    robot_description_command = [
            ...
            # 'stereo_camera_mount:=',
            # PathJoinSubstitution(
            #     [FindPackageShare('jackal_description'), 'urdf', 'hokuyo_ust10.urdf.xacro']
            # ),
        ]
    # camera_description_command = [
    #         PathJoinSubstitution([FindExecutable(name='xacro')]),
    #         ' ',
    #         PathJoinSubstitution(
    #             [FindPackageShare('jackal_description'), 'urdf', 'hokuyo_ust10.urdf.xacro']
    ...
    launch_jackal_description = IncludeLaunchDescription(
            ...
            launch_arguments=[('robot_description_command', robot_description_command)]#, ('camera_description_command', camera_description_command)]
        )
    ...
    #     executable='spawn_entity.py',
    #     name='spawn_camera',
    #     arguments=['-entity', 'camera', '-file', camera_description_command],
    #     output='screen',
    # )
    ...
    # ld.add_action(cam_resource_path)
